              ...
              <div className="surface-card p-6">
                ...
                <div className="mb-6">
                  ...
                  <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    {[
                      { label: 'Ethos', subtitle: 'Credibility', color: 'bg-blue-700', content: 'Establish credibility through your actions and demonstrated commitment to your team\'s welfare. Engineers follow leaders whose technical judgment they trust. Show up for code reviews, make sound architectural decisions, and follow through on commitments. Credibility is earned through consistency — one broken commitment erodes months of trust.' },
                      { label: 'Logos', subtitle: 'Logic & Data', color: 'bg-green-700', content: 'Use data and logical arguments to support decisions. "The p99 latency is 1.2s, our SLO is 500ms, this is why we need to address the database indexing this sprint" beats "the system feels slow." Quantify the cost of inaction. Show trade-offs with numbers. Engineers respond to data-backed reasoning.' },
                      { label: 'Pathos', subtitle: 'Emotional Connection', color: 'bg-purple-700', content: 'Use storytelling to connect emotionally and motivate. Tell the story of the customer being helped, the engineer who grew through a challenging project, the team\'s impact on the product. People work harder for meaning than metrics. Pair the data (Logos) with the human story (Pathos) for maximum impact.' },
                      { label: 'Metaphor', subtitle: 'Clarity', color: 'bg-orange-700', content: 'Use analogies to make complex technical concepts accessible and memorable. "Technical debt is like credit card debt — sometimes it\'s worth taking on, but the interest compounds." Good metaphors stick in stakeholder minds long after the meeting ends. Design metaphors that will be repeated in the conversations you\'re not in.' },
                      { label: 'Brevity', subtitle: 'Conciseness', color: 'bg-teal-700', content: 'Convey information concisely, especially at the start. Lead with the bottom line — executives hear dozens of updates daily. BLUF (Bottom Line Up Front): state your conclusion first, then your evidence. A status update that starts with context before the conclusion loses the audience before the point.' },
                    ].map((item, i) => (
