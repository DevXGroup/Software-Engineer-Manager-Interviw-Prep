      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 dark:from-blue-900 dark:via-indigo-900 dark:to-purple-900">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-center gap-6 lg:items-start lg:flex-row lg:justify-between">
            ...
            >
              {/* DevX Group LLC Logo */}
              <div className="relative h-16 w-40 shrink-0 overflow-hidden rounded-2xl bg-white/30 p-2 shadow-xl backdrop-blur-sm ring-2 ring-white/40 transition-all group-hover:scale-105 group-hover:shadow-2xl group-hover:bg-white/40">
                <Image
                  src="/devx-logo.png"
                  alt="DevX Group LLC"
                  fill
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:justify-between sm:flex-row">
            ...
            <div className="flex flex-col gap-2 w-full sm:w-auto sm:flex-row sm:gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 rounded-lg bg-gray-900 px-4 py-2.5 text-sm font-semibold text-white shadow-md transition-all hover:bg-gray-800 hover:shadow-lg hover:scale-105 dark:bg-gray-700 dark:hover:bg-gray-600"
              >
